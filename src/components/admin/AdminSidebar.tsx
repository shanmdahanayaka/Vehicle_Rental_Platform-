...
export default function AdminSidebar() {
  ...
  return (
    <aside data-tour="sidebar" className="fixed left-0 top-16 z-40 h-[calc(100vh-4rem)] w-64 bg-gradient-to-b from-slate-900 to-slate-800 text-white shadow-xl">
      {/* Admin Panel Title */}
