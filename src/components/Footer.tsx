...
import { brand, contact, socialMedia, locations, developer } from "@/config/site";
...
// Generate popular destinations from config
const popularDestinations = locations.popular.map((location) => ({
  name: location,
  href: `/vehicles?location=${location}`,
}));
